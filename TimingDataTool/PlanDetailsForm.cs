...
namespace TimingDataTool
{
    public partial class PlanDetailsForm : Form
    {
        public PlanDetailsForm(Intersection intersection, DayPlan dp)
        {
            ...
            //Add Rows
            dt.Rows.Add("Cycle", s.phase1.Length, s.phase2.Length, s.phase3.Length, s.phase4.Length, s.phase5.Length, s.phase6.Length, s.phase7.Length, s.phase8.Length, s.phase9.Length, s.phase10.Length, s.phase11.Length, s.phase12.Length, s.phase13.Length, s.phase14.Length, s.phase15.Length, s.phase16.Length);
